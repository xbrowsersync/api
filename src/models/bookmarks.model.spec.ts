...
import { Bookmarks, IBookmarks } from './bookmarks.model';
...
describe('Bookmarks', () => {
  ...
  it('bookmarksSchema: should create a default valid UUID', () => {
    ...
    const bookmarksModel = Bookmarks.construct(newBookmarks);
    const binary = Uuid.convertUuidStringToBinary(bookmarksModel.id);
  ...
  it('bookmarksSchema: should convert string uuid value to binary when setting id', () => {
    ...
    bookmarksModel.id = '2b7b65fb-62bc-4162-8ec5-0008183c69b0';
