...
var InfoRouter = /** @class */ (function (_super) {
    __extends(InfoRouter, _super);
    function InfoRouter() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    // Initialises the routes for this router implementation
    InfoRouter.prototype.initRoutes = function () {
    ...
    InfoRouter.prototype.getInfo = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var serviceInfo, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.service.getInfo(req)];
                    case 1:
                        serviceInfo = _a.sent();
