...
describe('BookmarksService', () => {
  ...
  const syncVersionTestVal = '1.0.0';
  ...
  it('createBookmarks: should throw a NewSyncsForbiddenException if service is not accepting new syncs', async () => {
    ...
    try {
      await bookmarksService.createBookmarks_v2(bookmarksDataTestVal, syncVersionTestVal, req as Request);
    }
    catch (err) {
  ...
  it('createBookmarks: should add a new sync log if daily new syncs limit is enabled', async () => {
    ...
    const newBookmarksSync = await bookmarksService.createBookmarks_v2(bookmarksDataTestVal, syncVersionTestVal, req as Request);
  ...
  it('createBookmarks: should return a new sync ID', async () => {
    ...
    const newBookmarksSync = await bookmarksService.createBookmarks_v2(null, syncVersionTestVal, req as Request);
